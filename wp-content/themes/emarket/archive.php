...
$emarket_page_layouts = apply_filters( 'emarket_fnc_get_archive_sidebar_configs', null );
					...
					<?php if ( have_posts() ) : ?>
						...
						<header class="page-header">
							<h1 class="page-title">
								<?php
									if ( is_day() ) :
										printf( esc_html__( 'Daily Archives: %s', 'emarket' ), get_the_date() );

									elseif ( is_month() ) :
										printf( esc_html__( 'Monthly Archives: %s', 'emarket' ), get_the_date( _x( 'F Y', 'monthly archives date format', 'emarket' ) ) );

									elseif ( is_year() ) :
										printf( esc_html__( 'Yearly Archives: %s', 'emarket' ), get_the_date( _x( 'Y', 'yearly archives date format', 'emarket' ) ) );
