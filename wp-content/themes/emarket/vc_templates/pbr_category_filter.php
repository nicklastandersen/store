...
<?php if($term):
 ...
 ?>
    <div class="widget pbr-category-filter woocommerce <?php echo (($el_class!='')?' '.esc_attr( $el_class ):''); ?>">
                ...
                <div class="category-filter-v1">
                    <div class="category-filter-content">
                        <h4 class="category-filter-title">
                         ...
                         <small><?php echo trim($term->count); ?> <?php esc_html_e( 'Products', 'emarket' );?></small>  
                        ...
                        <div class="category-filter-link">
                            <a href="<?php echo esc_url( $category_link ); ?>" title="<?php esc_html_e( 'more', 'emarket'); ?>" class=""><?php esc_html_e( '+ more...', 'emarket' ); ?></a>
                        </div>
                    </div>
